...
- Stable v1.0.0 release including core editor features:
  - Undo / Redo
...
- Ensure pressing Enter inside a list creates a new list item consistently across browsers.

### Notes

- This release consolidates the toolbar features into a stable v1.0.0 API and packages built artifacts.
